...
class OrgInfo(models.Model):
    ...
    category = models.CharField(choices=(('train_org', '培训机构'), ('colleges', '高校'),
                                         ('person', '个人')), max_length=10, verbose_name="机构类别")
    cityinfo = models.ForeignKey(CityInfo, verbose_name="所在城市", on_delete=models.CASCADE)   # 一对多 即同一城市有多个机构
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
...
class TeacherInfo(models.Model):
    image = models.ImageField(upload_to='teacher/', max_length=200, verbose_name="头像")
    name = models.CharField(max_length=20, verbose_name="讲师姓名")
    work_year = models.IntegerField(default=3, verbose_name="工作时间")
    ...
    work_company = models.ForeignKey(OrgInfo, verbose_name="所属机构", on_delete=models.CASCADE)  # 一对多
