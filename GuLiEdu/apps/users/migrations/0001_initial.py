    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(blank=True, max_length=120, null=True, verbose_name='用户地址')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send_type', models.ImageField(choices=[(1, 'register'), (2, 'forget'), (3, 'change')], upload_to='', verbose_name='验证类型')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
            ],
            options={
